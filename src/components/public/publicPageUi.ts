...
export const publicPageUi = {
  page:
    "caretip-public-page relative min-h-[100dvh] w-full min-w-0 overflow-x-hidden bg-[linear-gradient(180deg,#fafaf8_0%,#ffffff_42%,#f7f6f4_100%)] font-sans dark:bg-neutral-950",
  shell: "relative z-10 min-w-0",
  main:
    "mx-auto min-w-0 px-4 pb-16 pt-[calc(4.75rem+env(safe-area-inset-top,0px))] sm:px-6 sm:pb-20 lg:px-8 lg:pt-[calc(5.25rem+env(safe-area-inset-top,0px))]",
  backLink:
  ...
  cardInteractive:
    "transition-[box-shadow,border-color,transform] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-0.5 hover:border-primary/25 hover:shadow-[0_4px_12px_rgba(15,23,42,0.06),0_16px_40px_-12px_rgba(235,153,44,0.12)] dark:hover:border-primary/35",
  mutedBand:
  ...
  ctaPrimary:
    "inline-flex items-center justify-center gap-2 rounded-xl border-0 bg-[#EB992C] px-7 py-3 font-sans text-[0.9375rem] font-bold leading-none tracking-tight text-white no-underline shadow-[0_10px_26px_-10px_rgba(235,153,44,0.42)] transition-[box-shadow,background-color] duration-200 hover:bg-[#d88926] hover:shadow-[0_14px_36px_-8px_rgba(235,153,44,0.48)]",
  trustChip:
