...
export function AnimatedCard({ className, ...props }: CardProps) {
  return (
    <div
      ...
      className={cn(
        "group/animated-card relative w-full max-w-[356px] overflow-hidden rounded-xl border border-[#F0F0F0] bg-[#FAFAFA] shadow-[0_2px_8px_rgba(0,0,0,0.03)]",
        className,
      )}
      {...props}
    />
...
export function CardBody({ className, ...props }: CardProps) {
  return (
    <div
      role="group"
      className={cn("flex flex-col space-y-1.5 border-t border-[#F0F0F0] p-4", className)}
      {...props}
    />
  );
}
...
export function CardVisual({ className, ...props }: CardProps) {
  return <div className={cn("relative h-[180px] w-full overflow-hidden", className)} {...props} />;
}
