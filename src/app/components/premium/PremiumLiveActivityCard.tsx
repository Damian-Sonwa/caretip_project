      ...
      <div className="premium-live-card__header flex items-center justify-between gap-3 px-4 py-3.5 sm:px-5">
        <div className="flex min-w-0 items-center gap-2.5">
          <span className="relative flex h-2.5 w-2.5 shrink-0">
            <span className="absolute inline-flex h-full w-full rounded-full bg-[#EB992C] opacity-40" />
            <span className="relative inline-flex h-2.5 w-2.5 rounded-full bg-[#EB992C]" />
          </span>
