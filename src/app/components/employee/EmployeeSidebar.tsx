    ...
    >
      ...
      <div className="px-4 pb-4">
        <Link
          ...
          className="mb-2 flex w-full items-center gap-3 rounded-lg border border-border bg-muted px-3 py-2.5 text-foreground transition-colors hover:bg-muted/80"
        >
