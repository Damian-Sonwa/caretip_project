/** @deprecated Import from `@/app/components/dashboard/dashboardChartTheme` */
export {
  DASHBOARD_CHART_AXIS as BUSINESS_CHART_AXIS,
  DASHBOARD_CHART_BAR as BUSINESS_CHART_BAR,
